...
export(basic_transformer, x, "basic.onnx", verbose=False, input_names=["X"], output_names=["Y"])
...
from torch.onnx import export
export(basic_te_transformer, x, "te.onnx", verbose=True, input_names=["X"], output_names=["Y"])
